    ...
    <>
      ...
      <div className="mx-auto p-3 border-zinc-700 ">
        ...
        <div className="flex items-center gap-2 m-3 p-3">
          <div className="bg-red-200 h-[500px] w-[400px] rounded-3xl relative top-0 right-0 m-2 flex flex-col shadow-red-400 shadow-2xl cursor-pointer">
        ...
        <div className="mx-9 my-4 relative">
          ...
          <div className="flex items-center gap-2 text-slate-200 relative">
            <div className="p-4 bg-slate-500 h-[240px] w-[300px] gap-3 rounded-3xl m-2 relative border-gray-200 border-x-2 shadow-black shadow-xl cursor-pointer">
              Smart Work{" "}
              <svg
                xmlns="http://www.w3.org/2000/svg"
